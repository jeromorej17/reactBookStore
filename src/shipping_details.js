...
var ShippingDetails = createReactClass({
    ...
    _validateInput(){
      console.log('Are you having problem with me?');
    ...
    handleSubmit(event){
      ...
      console.log('Made it to handleSubmit method - formData:', formData);
      console.log('validated inputs result:',this._validateInput());
